            ...
            <form method="post" action="Rol">
                <div class="inputs">
                    <div>
                        ...
                        <input class="modal_input" type="text" placeholder="Descripción" name="rolDescripcion" required >            
                    </div>
                </div>
        ...
        <div class="modal_container">
            ...
            <form method="post" action="Rol">
                ...
                <div class="inputs">
                    ...
                    <div>
                        <label class="modal_paragraph" >Descripción:<span class="asterisco"> *</span></label>
                        <input class="modal_input" type="text" placeholder="Descripción" name="rolDescripcion" required id="rol_desc" >   
                    </div>
