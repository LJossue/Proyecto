            ...
            <form method="post" action="Usuario">
                ...
                <div class="inputs">
                    <div>
                        ...
                        <input class="modal_input" type="number" placeholder="Nombre" name="usuId" required readonly id="usu_id" required>            
                    </div>
                    <div>
                        <label class="modal_paragraph">Nombre:<span class="asterisco"> *</span></label>
                        <input class="modal_input" type="text" placeholder="Nombre" name="usuNombre" id="usu_nom" required>            
                    </div>
                    <div>
                        <label class="modal_paragraph">Apellido:<span class="asterisco"> *</span></label>
                        <input class="modal_input" type="text" placeholder="Apellido" name="usuApellido" id="usu_ape" required>            
                    </div>
                    <div>
                        <label class="modal_paragraph">Tipo de documento:<span class="asterisco"> *</span></label>
                        <select class="modal_input" name="usuTipoDocumento"  required id="usu_tip">
                    ...
                    <div>
                        ...
                        <input class="modal_input" type="number" placeholder="Documento" name="usuDocumento" id="usu_doc" required>            
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input class="modal_input" type="number" placeholder="Teléfono" name="usuTelefono" id="usu_tel" required>            
                    </div>
                    <div>

                        <label class="modal_paragraph">Rol:<span class="asterisco"> *</span></label>
                        <select class="modal_input"  name="rolId_fk" required id="usu_rol">            
