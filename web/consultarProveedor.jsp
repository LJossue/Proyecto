        ...
        <div class="modal_container">
            ...
            <form method="post" action="Proveedor">
                    ...
                    <div>
                                        ...
                                        <input class="modal_input" type="text" placeholder="Nombre" name="prvNombre" required >            
                                    </div>
                                 <div>
                               ...
                               <div>
                                ...
                                <div>
                                        ...
                                        <input class="modal_input" type="number" placeholder="Teléfono" name="prvTelefono" >            
                                    </div>
                               </div>
            ...
            <form method="post" action="Proveedor">
                ...
                <div class="inputs">
                     <div>
                                        ...
                                        <input class="modal_input" type="number" placeholder="Nombre" name="prvId" required readonly id="prv_id">            
                                    </div>
                    <div>
                                        <label class="modal_paragraph">Nit:<span class="asterisco"> *</span></label>
                    ...
                    <div>
                                        <label class="modal_paragraph">Nombre:<span class="asterisco"> *</span></label>
                                        <input class="modal_input" type="text" placeholder="Nombre" name="prvNombre" required id="prv_nom" >            
                                    </div>
                                 <div>
                                        <label class="modal_paragraph">Dirección:</label>
                               ...
                               <div>
                                ...
                                <div>
                                        <label class="modal_paragraph">Teléfono:</label>
                                        <input class="modal_input" type="number" placeholder="Teléfono" name="prvTelefono" id="prv_tel">            
                                    </div>
