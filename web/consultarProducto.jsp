            ...
            <form method="post" action="Producto">
                           <div class="inputs">
                                    <div>
                                        ...
                                        <input class="modal_input" type="text" placeholder="Nombre" name="proNombre" required >            
                                    </div>
                               <div>
                        
                        <label class="modal_paragraph">Categoría:<span class="asterisco"> *</span></label>
                                        <select class="modal_input"  name="catId_fk" required id="cat2">            
        ...
        <div class="modal_container">
            ...
            <form method="post" action="Producto">
                ...
                <div class="inputs">
                    ...
                    <div>
                           <label class="modal_paragraph" >Nombre:<span class="asterisco"> *</span></label>
                                         <input class="modal_input" type="text" placeholder="Nombre" name="proNombre" required  id="pro_nom">    
                    </div>
                    <div>
                        
                        <label class="modal_paragraph">Categoría:<span class="asterisco"> *</span></label>
                                        <select class="modal_input"  name="catId_fk" required id="pro_cat">            
