  ...
  <section class="modal modal_registrar_cliente">
        <div class="modal_container">
            ...
            <form method="post" action="Cliente">
                           <div class="inputs">
                                    <div>
                                        <label class="modal_paragraph">Nombre:</label>
                                        <input class="modal_input" type="text" placeholder="Nombre" name="cliNombre">            
                                    </div>
                                 <div>
                                        <label class="modal_paragraph">Apellido:</label>
                                        <input class="modal_input" type="text" placeholder="Apellido" name="cliApellido">            
                                    </div>
                               <div>
                                        <label class="modal_paragraph">Tipo de documento:</label>
                                        <select class="modal_input" name="cliTipoDocumento">
                               ...
                               <div>
                                        ...
                                        <input class="modal_input" type="number" placeholder="Documento" name="cliDocumento" >            
                                    </div>
                               <div>
                               ...
                               <div>
                                ...
                                <div>
                                        ...
                                        <input class="modal_input" type="number" placeholder="Teléfono" name="cliTelefono" >            
                                    </div>
                               </div>
        ...
        <div class="modal_container">
            ...
            <form method="post" action="Cliente">
                ...
                <div class="inputs">
                    ...
                    <div>
                                        <label class="modal_paragraph">Nombre:</label>
                                        <input class="modal_input" type="text" placeholder="Nombre" name="cliNombre" id="cli_nom" >            
                                    </div>
                                 <div>
                                        <label class="modal_paragraph">Apellido:</label>
                                        <input class="modal_input" type="text" placeholder="Apellido" name="cliApellido" id="cli_ape">            
                                    </div>
                               <div>
                                        <label class="modal_paragraph">Tipo de documento:</label>
                                        <select class="modal_input" name="cliTipoDocumento" id="cli_tip">
                                            <option value="">Seleccione...</option>
                                            <option value="CC">CC</option>
                                            <option value="TI">TI</option>
                                            <option value="CE">CE</option>
                               ...
                               <div>
                                        <label class="modal_paragraph">Documento:</label>
                                        <input class="modal_input" type="number" placeholder="Documento" name="cliDocumento" id="cli_doc">            
                                    </div>
                               <div>
                                        <label class="modal_paragraph">Correo electrónico:</label>
                               ...
                               <div>
                                ...
                                <div>
                                        <label class="modal_paragraph">Teléfono:</label>
                                        <input class="modal_input" type="number" placeholder="Teléfono" name="cliTelefono" id="cli_tel">            
                                    </div>
