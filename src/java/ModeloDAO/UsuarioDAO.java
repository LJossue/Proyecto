...
public class UsuarioDAO extends ConexionBd implements Crud {
    ...
    public boolean agregarRegistro() {
        ...
        rolId_fk = "4";
        try {
            sql = "insert into usuario (usuCorreo, usuContrasena, usuApellido, usuNombre, usuTipoDocumento, usuDocumento, usuTelefono, usuDireccion, usuEstado, rolId_fk) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    public boolean iniciarSesion(String usuario, String clave) {
        try {
            ...
            conexion = this.obtenerConexion();
            sql = "select * from usuario where usuCorreo = ? and usuContrasena=?";
            puente = conexion.prepareStatement(sql);
    ...
    return idRol;
     ...
     public ArrayList<UsuarioVO> listar(){
        ...
        try { 
            conexion = this.obtenerConexion();
        sql="select * from consulta_usuario order by case usuEstado WHEN 'Activo' THEN 0 ELSE 1 END;";
        puente = conexion.prepareStatement(sql);
